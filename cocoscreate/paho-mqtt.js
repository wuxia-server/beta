...
//    	    	break;
	...
	ClientImpl.prototype._doConnect = function (wsurl) {
		...
		var pem = cc.url.raw("resources/cacert.pem");
		// var pem = cc.url.raw("resources/cacert.crt");
		if(cc.loader.md5Pipe) {
			pem = cc.loader.md5Pipe.transformURL(pem)
			console.log('[paho-mqtt] _doConnect: md5Pipe: ' + pem);
		}
		console.log('[paho-mqtt] _doConnect: wsurl: ' + wsurl);
		console.log('[paho-mqtt] _doConnect: pem: ' + pem);
		
		if (this.connectOptions.mqttVersion < 4) {
			if (this.connectOptions.useSSL) {
				console.log('[paho-mqtt] _doConnect mqttv3.1 useSSL new WebSocket');
				this.socket = new WebSocket(wsurl, null, pem);
			} else {
				console.log('[paho-mqtt] _doConnect mqttv3.1 new WebSocket');
				this.socket = new WebSocket(wsurl, ["mqttv3.1"]);
			}
		} else {
			if (this.connectOptions.useSSL) {
				console.log('[paho-mqtt] _doConnect mqtt useSSL new WebSocket');
				this.socket = new WebSocket(wsurl, null, pem);
			} else {
				console.log('[paho-mqtt] _doConnect mqtt new WebSocket');
   ...
   * up to 128 seconds.
	...
	ClientImpl.prototype._disconnected = function (errorCode, errorText) {
		console.log('[paho-mqtt] _disconnected errorCode: ' + errorCode)
		console.log('[paho-mqtt] _disconnected errorText: ' + errorText)
